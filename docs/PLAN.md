...
|------|---------|----------------|
| 2026-01-29 | #36 | Race Creation Build Filter Fix - Removed myBuilds=true parameter from race creation page to show all builds (including public builds from other users) instead of only user's own builds |
